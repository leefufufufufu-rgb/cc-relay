...
function reportUsage(deviceKey, tokenTail, u, controlPlaneUrl) {
  ...
  try {
    const body = JSON.stringify({
      account: tokenTail, in: u.input || 0, out: u.output || 0,
            ...
            r.on('end', () => {
              try {
                ...
                if (u.input != null || u.output != null) {
                  reportUsage(deviceKey, tokenTail, u, controlPlaneUrl);
                }
              } catch (_) {}
            });
          }
...
module.exports = { startEgressProxy, scanUsage, decode, reportUsage, connectThroughUpstream };
